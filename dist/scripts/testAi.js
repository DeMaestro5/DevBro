...
async function testAi() {
    ...
    const encouragingMsg = await aiClient.generateMessage(goodActivity, 'encouraging');
    ...
    const challengingMsg = await aiClient.generateMessage(lowActivity, 'challenging');
